...
<div class="py-5 mb-5 container-fluid page-header">
    <div class="container py-5">
        <h1 class="mb-3 text-white display-3 animated slideInDown">IT Services</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                <li class="text-white breadcrumb-item active" aria-current="page">IT Services</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="overflow-hidden rounded service-item">
                    <img class="img-fluid" src="{{asset('assets/Frontend/img/it-project-1.jpg')}}" alt="">
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="overflow-hidden rounded service-item">
                    <img class="img-fluid" src="{{asset('assets/Frontend/img/it-project-3.jpg')}}" alt="">
                    <div class="p-4 pt-0 position-relative">
                        <div class="service-icon">
