...
<div class="py-5 mb-5 container-fluid page-header">
    <div class="container py-5">
        <h1 class="mb-3 text-white display-3 animated slideInDown">A/C Services</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                <li class="text-white breadcrumb-item active" aria-current="page">AC Service</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="py-5 container-xxl">
    <div class="container">
        <div class="mx-auto mb-5 text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            ...
            <h1 class="mb-4">We Are Pioneers In The World Of Cooling & Heating Systems</h1>
        </div>
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="overflow-hidden rounded service-item">
                    <img class="img-fluid" src="{{asset('assets/Frontend/img/ac-service-5.jpg')}}" alt="">
                    <div class="p-4 pt-0 position-relative">
                        <div class="service-icon">
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="overflow-hidden rounded service-item">
                    <img class="img-fluid" src="{{asset('assets/Frontend/img/ac-service-3.jpg')}}" alt="">
                    <div class="p-4 pt-0 position-relative">
                        <div class="service-icon">
                            <i class="fa fa-wind fa-3x"></i>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="overflow-hidden rounded service-item">
                    <img class="img-fluid" src="{{asset('assets/Frontend/img/ac-service-4.jpg')}}" alt="">
                    <div class="p-4 pt-0 position-relative">
                        <div class="service-icon">
                            <i class="fa fa-lightbulb fa-3x"></i>
                        </div>
